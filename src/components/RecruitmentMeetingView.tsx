      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap shrink-0">
          <button
            ...
            disabled={isSaving}
            className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-3.5 py-2 rounded-xl transition-all cursor-pointer flex items-center gap-1.5 shadow-2xs"
          >
          ...
          <button
            ...
            className="bg-white hover:bg-indigo-50 text-indigo-700 border border-indigo-200 font-bold text-xs px-3 py-2 rounded-xl transition-colors cursor-pointer flex items-center gap-1.5 disabled:opacity-50"
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-2 rounded-xl font-bold text-xs transition-all cursor-pointer flex items-center gap-2 shrink-0 ${
                    isSelected
                      ? 'bg-indigo-600 text-white shadow-xs ring-2 ring-indigo-200 font-extrabold'
                    ...
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        {cand.avatarUrl ? (
                          ...
                          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-100 to-slate-200 text-indigo-700 font-extrabold text-xs flex items-center justify-center shrink-0 border border-slate-200">
                            {cand.name.slice(0, 1)}
                          </div>
                        )}
            ...
            <div className="bg-slate-50 rounded-xl p-3 border border-slate-200/90 space-y-2 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2 text-center">
                ...
                <div className="bg-white p-2 rounded-lg border border-slate-200">
                  ...
                  <span className="font-extrabold text-amber-700 font-mono text-xs">{finalOfferCount}名</span>
                </div>
                <div className="bg-white p-2 rounded-lg border border-slate-200">
            ...
            <div className="space-y-1.5">
              ...
              {currentReport?.progressLog && (
                <div className="bg-indigo-50/70 border border-indigo-200 rounded-xl p-2.5 text-xs text-indigo-950 font-medium leading-relaxed">
                  <span className="font-extrabold text-indigo-900 block mb-0.5">【✨ AI/Drive抽出ログ】</span>
                  {currentReport.progressLog}
                </div>
              )}
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center text-xs">
                    ...
                    <div className="bg-amber-50/70 border border-amber-200 p-2.5 rounded-xl">
                      <span className="text-[10px] text-amber-700 font-bold block">4. 最終 / 内定</span>
                      <span className="text-base font-black text-amber-900 font-mono mt-0.5 block">{sumOffer} <span className="text-xs font-normal text-amber-600">名</span></span>
                      <span className="text-[10px] text-amber-600 font-mono block">({sumFirstPass > 0 ? Math.round((sumOffer / sumFirstPass) * 100) : 0}%)</span>
                    </div>
                            ...
                            return (
                              <tr key={ag.id} className="hover:bg-slate-50/60 transition-colors">
                                ...
                                <td className="py-2.5 px-2 text-center">
                                  ...
                                  <span className="text-[10px] text-amber-600 font-mono bg-amber-50 px-1.5 py-0.2 rounded font-semibold">
                                    {st.offerRate}%
                                  </span>
                                </td>
                                <td className="py-2.5 px-2 text-center">
