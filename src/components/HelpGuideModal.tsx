...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '辞退・不採用になった候補者は「過去候補者一覧」に移動し、必要であれば復元できます。'
    ]
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    body: [
      ...
      '担当者ごと、または複数人で見るスペース宛に、Google Chatへの通知Webhookを登録できます（新規候補者アサイン・選考結果確定・書類選考の督促・書類選考通過スレッド作成・お問い合わせなど、通知の種類ごとに受け取るWebhookを選べます）。'
    ]
  },
  {
    icon: HardDrive,
  ...
  },
  {
    ...
    body: [
      ...
      '送信した内容は開発者側のGoogle Chatに通知され、同じお問い合わせは同じスレッドとして続けて確認できます。'
    ]
  }
];
